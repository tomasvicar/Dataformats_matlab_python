...
#     ## 8.9s 368MB; read 0.31s
#     dst_mask = f.create_dataset('mask/041', data=mask, chunks=(128,128,48), compression="lzf")
    
#     dst_img = f.create_dataset('img/041', data=img,chunks=(128,128,48,3), compression="lzf")
